...
dispatch(toggleMenu())
  ...
  return (
    ...
    <div className=' grid grid-flow-col shadow-md p-4'>
      <div className="menu flex col-span-1 gap-4 items-center">
      <div className="text-lg cursor-pointer" onClick={()=>toggleMenuHandler()}><MdOutlineMenu className='text-3xl '/> </div>
       <div className="text-red-500 flex font-bold items-center">  <FaYoutube  className='text-3xl mr-1'/>YOUTUBE </div> 
        </div> 
        <div className="search col-span-10 flex items">
